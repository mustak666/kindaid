<?php
   ...
   $header_menu_column = ($header_right_info_switch == false) ? 'col-lg-12 col-5' : 'col-lg-10 col-5' ;

   $header_menu_position = ($header_right_info_switch == false) ? 'justify-content-between' : '' ;
...
?>
   ...
   <?php echo get_template_part('template-parts/headers/searchform');?>
   <?php echo get_template_part('template-parts/headers/cartmini');?>
