...
<?php 
    ...
    $post_meta =  is_single() ? 'tp-postbox-meta tp-postbox-meta-border pb-30 mb-35': 'tp-postbox-meta';
?>


        
<div class="<?php echo esc_attr($post_meta);?> mb-15">
    <span><a href="<?php print esc_url( get_author_posts_url( get_the_author_meta( 'ID' ) ) );?>"> <img src="<?php echo esc_url( get_avatar_url( $user->ID ) ); ?>" alt=" By <?php the_author(); ?>"> By <?php the_author(); ?></a></span>
    <span>
