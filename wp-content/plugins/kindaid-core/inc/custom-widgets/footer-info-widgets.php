...
class Kindaid_Footer_Info_widget extends WP_Widget {
    ...
    public function widget($args, $instance) {
        ...
        <p class="tp-footer-dec mb-30"><?php echo esc_html($description);?></p>
        <?php endif;?>
    ...
    public function form($instance) {
        ...
        <p>
            <label><?php echo esc_html__('Title:','kindaid');?></label>
        ...
        <p>
            ...
            <textarea class="widefat" rows="4" name="<?php echo esc_attr($this->get_field_name('description')); ?>"><?php echo esc_textarea($description); ?></textarea>
        </p>
