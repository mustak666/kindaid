...
foreach ( $social_icons as $icon ) {
	...
	if ( ! empty( $icon_url ) ) {
		?>
		<?php echo $charitable_wrapper; // phpcs:ignore ?> .charitable-field.charitable-field-social-links .charitable-social-linking-preview-<?php echo esc_attr( $icon ); ?> .charitable-placeholder,
		<?php echo $charitable_wrapper; // phpcs:ignore ?> .charitable-field.charitable-field-social-sharing .charitable-social-sharing-preview-<?php echo esc_attr( $icon ); ?> .charitable-placeholder {
