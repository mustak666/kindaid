...
if ( ! class_exists( 'Charitable_Builder_Panel_Marketing_Campaign_Monitor' ) ) :
	...
	class Charitable_Builder_Panel_Marketing_Campaign_Monitor {
		 ...
		 * @var string
		 */
		private $needed_addon_url = 'charitable-newsletter-connect/charitable-newsletter-connect.php';
		 ...
		 * @var string
		 */
		private $needed_addon_name = 'Charitable Newsletter Connect';
		 ...
		 * @var string
		 */
		private $provider_slug = 'campaign_monitor';
		...
		public function panel_content() {
			...
			$button_url   = admin_url( 'admin.php?page=charitable-settings&tab=extensions' );
