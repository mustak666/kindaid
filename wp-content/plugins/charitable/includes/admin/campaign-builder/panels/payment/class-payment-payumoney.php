...
if ( ! class_exists( 'Charitable_Builder_Panel_Payment_PayUMoney' ) ) :

	/**
	 * PayUMoney subpanel for Marketing Panel for campaign builder.
	 *
	 * @since 1.8.0
	 */
	class Charitable_Builder_Panel_Payment_PayUMoney {
		 ...
		 * @var string
		 */
		private $needed_addon_url = 'charitable-payumoney/charitable-payumoney.php';
		 ...
		 * @var string
		 */
		private $needed_addon_name = 'Charitable PayUMoney';
		 ...
		 * @var string
		 */
		private $provider_slug = 'payumoney';
		...
		public function __construct() {
			...
			$this->primary_label = esc_html__( 'PayUMoney', 'charitable' );
	...
	new Charitable_Builder_Panel_Payment_PayUMoney();
