...
if ( ! class_exists( 'Charitable_Builder_Panel_Payment_AuthorizeNet' ) ) :
	...
	class Charitable_Builder_Panel_Payment_AuthorizeNet {
		 ...
		 * @var string
		 */
		private $needed_addon_url = 'charitable-authorize-net/charitable-authorize-net.php';
		 ...
		 * @var string
		 */
		private $needed_addon_name = 'Charitable Authorize.Net';
		 ...
		 * @var string
		 */
		private $provider_slug = 'authorize_net';
