...
if ( ! class_exists( 'Charitable_Builder_Panel_Payment_Gocardless' ) ) :
	...
	class Charitable_Builder_Panel_Payment_Gocardless {
		 ...
		 * @var string
		 */
		private $needed_addon_url = 'charitable-gocardless/charitable-gocardless.php';
		 ...
		 * @var string
		 */
		private $needed_addon_name = 'Charitable GoCardless';
		 ...
		 * @var string
		 */
		private $provider_slug = 'gocardless';
